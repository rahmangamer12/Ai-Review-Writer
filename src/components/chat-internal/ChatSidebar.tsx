          ...
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            {userData?.imageUrl ? (
              <img 
                ...
                className="w-8 sm:w-9 lg:w-10 h-8 sm:h-9 lg:h-10 rounded-lg sm:rounded-xl object-cover border border-white/10"
              />
            ) : (
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs sm:text-sm font-semibold truncate">{userData?.name || 'User Profile'}</p>
