  ...
  return (
    <div className="flex h-[100dvh] w-full bg-[#030308] text-white overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col min-w-0 w-full relative z-10">
        ...
        <div className="shrink-0 fixed bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-[#030308] via-[#030308]/95 to-transparent pb-[calc(12px+env(safe-area-inset-bottom))] lg:pb-8 pt-4 px-4 lg:px-12">
