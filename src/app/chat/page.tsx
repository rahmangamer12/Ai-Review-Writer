  ...
  return (
    <div className="flex h-[100dvh] w-screen bg-[#030308] text-white overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col min-w-0 w-full relative z-10">
        ...
        {/* Messages Area */}
        <div ref={chatContainerRef} className="flex-1 overflow-y-auto custom-scrollbar bg-transparent px-4 sm:px-6 lg:px-8">
        ...
        {/* Input Area */}
        <div className="shrink-0 bg-gradient-to-t from-[#030308] via-[#030308] to-transparent pb-[calc(16px+env(safe-area-inset-bottom))] lg:pb-8 pt-4 px-4 sm:px-6 lg:px-8">
